...
/***/ function(module, exports, __webpack_require__) {
	...
	var _description = __webpack_require__(184);
	...
	var getExample = function getExample(file) {
	    if (examples[file]) return Promise.resolve(examples[file]);
	    return new Promise(function (resolve, reject) {
	        return _jquery2.default.getJSON(file, resolve);
	    ...
	    _createClass(Site, [{
	        ...
	        value: function componentWillMount() {
	            if (this.props.choices) {
	                var choices = Object.keys(this.props.choices);
	        ...
	        key: 'onSelectChoice',
	        value: function onSelectChoice(choice) {
	            var _this2 = this;

	            var pick = texts[choice];
	            if (!pick) return;

	            getExample(pick).then(function (example) {
	                _this2.setState({
	                    choice: choice,
	                    example: example,
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'div',
	                        { id: 'ouput-container', className: 'container-fluid' },
	                        examples
	                    ),
	                    _react2.default.createElement(
	                        'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Urban = function () {
	    function Urban(extractor) {
	        _classCallCheck(this, Urban);

	        this._cache = new Map();
	        this._extractor = extractor || function (x) {
	            return x;
	        };
	    }
	    ...
	    _createClass(Urban, [{
	        ...
	        value: function lookup(word) {
	            ...
	            var cachedResult = this._lookupCache(key);
	            if (cachedResult) return Promise.resolve(cachedResult);

	            return this._lookupUrban(key).then(this._extractor).then(function (result) {
	                _this._updateCache(key, result);
	                return result;
	            });
	        }
	    }, {
	        key: '_updateCache',
	        value: function _updateCache(key, result) {
	            this._cache.set(key, result);
	        }
	    }, {
	        key: '_lookupCache',
	        value: function _lookupCache(key) {
	            return this._cache.get(key);
	        }
	    }, {
	        key: '_lookupUrban',
	        value: function _lookupUrban(key) {
	            return new Promise(function (resolve, reject) {
	                return xhr({
	                    ...
	                    if (!data) return reject('invalid json');
	                    return resolve(data);
	                });
	            });
	        }
	...
	var instance = exports.instance = Urban.instance = new Urban(function (x) {
	    if (x.list && x.list[0]) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	var Letter = function (_React$Component) {
	    ...
	    _createClass(Letter, [{
	        ...
	        value: function render() {
	            ...
	            var pre = word.slice(0, this.props.index);
	            var post = word.slice(this.props.index + 1);

	            var animatingClass = this.state.animating ? 'fade' : '';
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: 'letter-line', style: style },
	                _react2.default.createElement(
	                    'b',
	                    { className: 'letter' },
	                    this.props.letter
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'div',
	                        { className: "pre col " + animatingClass },
	                        _react2.default.createElement(
	                            'span',
	                            null,
	                            pre
	                    ...
	                    _react2.default.createElement(
	                        'div',
	                        { className: "post col " + animatingClass },
	                        _react2.default.createElement(
	                            'span',
	                            null,
	                            post
	...
	var allIndicies = function allIndicies(str, c) {
	    var indices = [];
	...
	var Header = function (_React$Component2) {
	    ...
	    function Header(props) {
	        ...
	        _this3._updates = new Set(letters);
	        return _this3;
	    }
	    ...
	    _createClass(Header, [{
	        ...
	        key: 'updateText',
	        value: function updateText(phrase) {
	            ...
	            try {
	                for (var _iterator2 = this._updates[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
	                    var l = _step2.value;

	                    var indicies = allIndicies(phraseLower, l[0]);
	                    if (indicies.length) {
	        ...
	        value: function render() {
	            ...
	            var words = letters.map(function (l, i) {
	                var state = _this5.state[l];
	                return _react2.default.createElement(Letter, { key: l, letter: l[0], word: state.word, index: state.index, i: i });
	            });
	            return _react2.default.createElement(
	                'header',
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    ' is an experiment that finds occurrences of ',
	                    _react2.default.createElement(
	                        'i',
	                        null,
	                        'Urban Dictionary'
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'a',
	                        { href: 'https://github.com/mattbierner/vernacular' },
	                        'Source Code'
	                    )
	                ),
	                _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Definition = function (_React$Component) {
	    _inherits(Definition, _React$Component);

	    function Definition(props) {
	        _classCallCheck(this, Definition);

	        var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Definition).call(this, props));
	...
	var Example = function (_React$Component2) {
	    ...
	    _createClass(Example, [{
	        ...
	        value: function componentWillMount() {
	            ...
	            _urban2.default.instance.lookup(this.props.synonym).then(function (def) {
	                _this3.setState({ definition: def });
	            });
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            var style = { display: this.state.definition ? 'block' : 'none' };

	            return _react2.default.createElement(
	                'div',
	                { className: 'example', style: style },
	                _react2.default.createElement(
	                    'h2',
	                    { className: 'synonym' },
	                    this.props.synonym
	                ...
	                _react2.default.createElement(Definition, _extends({}, this.props, { definition: this.state.definition }))
	            );
	        }
	    }]);
